...
ActiveRecord::Schema.define(version: 2019_03_10_220644) do
  ...
  create_table "global_mute_words", force: :cascade do |t|
    t.string "phrase"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "shared_filters", force: :cascade do |t|
    t.datetime "expires_at"
    t.text "phrase"
    t.string "context"
